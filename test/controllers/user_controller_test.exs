defmodule H3acatalog.UserControllerTest do
  use H3acatalog.ConnCase

  import H3acatalog.TestHelpers
  alias H3acatalog.{Repo, User}

  @valid_attrs %{username: "bill", email: "bill@mail.com", password: "^hEsdg*F899"}
  @invalid_attrs %{email: "", password: ""}

  setup %{conn: conn} = config do
    conn = conn |> bypass_through(H3acatalog.Router, :browser) |> get("/")
